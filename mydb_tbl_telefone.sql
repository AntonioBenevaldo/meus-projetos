...
CREATE TABLE `tbl_telefone` (
  ...
  KEY `fk_tbl_telefone_tbl_colaboradores1_idx` (`id_colaboradores`),
  CONSTRAINT `fk_tbl_telefone_tbl_colaboradores1` FOREIGN KEY (`id_colaboradores`) REFERENCES `tbl_colaboradores` (`id`)
