...
# BASE_DIR: local do código (útil para recursos empacotados no PyInstaller).
# DATA_DIR: dados do usuário (JSON/logs) em AppData, para funcionar mesmo instalado em Program Files.
